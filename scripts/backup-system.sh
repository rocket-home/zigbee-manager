...
- Логи системы исключены для экономии места
...
mkdir -p mqtt/config mqtt/data zigbee2mqtt/data
...
# Восстановление логов исключено
...
echo "   • Логи системы исключены для экономии места"
