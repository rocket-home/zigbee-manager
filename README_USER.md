# Zigbee2MQTT Manager - Руководство пользователя
...
- **Zigbee адаптер** (CC2531, CC2538, CC2652P и др.)
...
```bash
# Настройка с генерацией параметров безопасности сети
make secure-setup
```
...
#### Обычная генерация конфигураций:
...
**По умолчанию:**
- **Локальный топик**: `zigbee2mqtt/#`
- **Облачный топик**: `home/zigbee/#`

**Направления синхронизации:**
- 📤 **Локальный → Облачный**: Все сообщения от Zigbee устройств
- 📥 **Облачный → Локальный**: Команды управления (опционально)
